    ...
    <div className={b()}>
      <Carousel
        ...
        onSelect={(index, element) => {
          onSelect(order[index].id);
        }}
        activeIndex={order.findIndex(item => item.id == activeList)}
        touch
      >
      ...
      <ul className={b("nav")}>
        <li className={b("nav-item")}>
          <a
            href="#"
            className={b("link", { list: "western", current: activeList == 1 })}
            onClick={e => {
              e.preventDefault();
              onSelect(0);
            }}
        ...
        <li className={b("nav-item")}>
          <a
            href="#"
            className={b("link", { list: "russian", current: activeList == 3 })}
            onClick={e => {
              e.preventDefault();
              onSelect(1);
            }}
        ...
        <li className={b("nav-item")}>
          <a
            href="#"
            className={b("link", { list: "korean", current: activeList == 4 })}
            onClick={e => {
              e.preventDefault();
              onSelect(3);
            }}
