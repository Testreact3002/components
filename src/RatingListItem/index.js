...
class RatingListItem extends Component{
  ...
  render(){
      return <div className={b({type:this.props.type})}>
       ...
       <a className={b("cover-link")} href={this.props.movieUrl}>{(this.props.image)?<img className={b("cover")} src={this.props.image} onClick={this.props.onClick.bind(null,this.props)}/>:null}</a>
       <div className={b("title")}><a href={this.props.movieUrl} onClick={this.props.onClick.bind(null,this.props)}>{this.props.title} <span className={b("year")}>{this.props.year}</span></a></div>
